...
const WorkspaceDashboard = () => {
  ...
  console.log("Workspace Dashboard ", filteredTasks);

  let currentTab = "tasks";
  if (location.pathname.includes("/members")) currentTab = "members";
  if (location.pathname.includes("/report")) currentTab = "report";
    ...
    content = (
      <>
        <Tabs value={currentTab}>
            ...
            <div className=" w-full flex justify-end p-6 shadow">
              ...
              <TabsList className="mr-4">
                <TabsTrigger value="tasks">
                  <Link to={`/workspace/${workspaceId}/tasks`}>Tasks</Link>
                </TabsTrigger>
                <TabsTrigger value="members">
                  <Link to={`/workspace/${workspaceId}/members`}>Members</Link>
                </TabsTrigger>
                {role === "admin" && (
                  <TabsTrigger value="report">
                    <Link to={`/workspace/${workspaceId}/report`}>Report</Link>
                  </TabsTrigger>
                )}
              </TabsList>
              {role === "admin" && (
          ...
          <Outlet context={{ role, filteredTasks, isLoading, isError }} />
        </TabsContent>
